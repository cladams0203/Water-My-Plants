...
public class Swagger2Config
{
    ...
    private ApiInfo apiEndPointsInfo()
    {
        return new ApiInfoBuilder().title("Water My Plants Api")
                .description("Api for a plant watering frequency app")
                .contact(new Contact("Chris Adams",
                        "christopher-adams.com",
                        "cladams0203@gmail.com"))
                .license("MIT")
                .licenseUrl("https://github.com/cladams0203/Water-My-Plants/blob/master/LICENSE")
                .version("1.0.0")
                .build();
    }
}
